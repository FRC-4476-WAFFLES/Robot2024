...
public class SpinUp extends Command {
  ...
  private double calculateAngleOffDistance(double distance) {
    ...
    shooterAngleMap.put(5.8711, 31.55 + generalAnglerAdjustment+0.25);
    shooterAngleMap.put(6.0, 31.55 + generalAnglerAdjustment); //approx alliance line
    shooterAngleMap.put(6.5, 31.23 + generalAnglerAdjustment - 1);
    shooterAngleMap.put(7.9, 29.25 + generalAnglerAdjustment - 2);
    shooterAngleMap.put(8.3, 29.0 + generalAnglerAdjustment - 2);
    shooterAngleMap.put(8.7, 28.5 + generalAnglerAdjustment - 2);
